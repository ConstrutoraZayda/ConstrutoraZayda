...
(function () {
  const HOME_POSTS = [
    { route:'artigo-materiais',        cat:'Arquitetura',          title:'Pedra. Madeira. Luz. O que cinco mil anos de arquitetura tentam nos dizer.',  excerpt:'Cada material carrega milênios de acertos e erros. Uma leitura sobre o que nos ensinaram o tijolo, a pedra e a madeira.',                           img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779713431/a921ee246879721.69d36fc149dfc_ptqgn5.webp' },
    { route:'artigo-bem-estar',        cat:'Bem Estar',            title:'Bem-Estar Não É Um Cômodo.',                                                   excerpt:'Espaços que geram conforto real não surgem de um projeto de interiores. Surgem de decisões tomadas antes de colocar a primeira pedra.',          img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779219813/ec7a05240187127.693942248159b_fat1nk.webp' },
    { route:'artigo-impermeabilizacao',cat:'Bem Estar',            title:'O Que Acontece com Sua Obra Quando Chove.',                                    excerpt:'60% das patologias em edificações têm origem na água. Não é azar — é decisão de projeto.',                                                       img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779288159/3e1011226538547.68375be87851c_tknnxq.webp' },
    { route:'artigo-luz',              cat:'Bem Estar',            title:'Sua Casa Sabe Que Horas São?',                                                  excerpt:'A orientação solar de um dormitório afeta seu sono mais do que qualquer colchão.',                                                               img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779288889/6f1ff9236946593.68f6bff40df3d_o11lwi.webp' },
    { route:'artigo-cozinha',          cat:'Arquitetura',          title:'A Cozinha Virou Outra Coisa.',                                                  excerpt:'De laboratório de eficiência a centro arquitetônico — e o que essa virada exige da obra.',                                                      img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779293264/dbaf04248279303.69ee25a666e7d_e46wsc.webp' },
    { route:'artigo-metros',           cat:'Mercado',              title:'Por Que os Imóveis Mais Caros do Mundo São Menores.',                           excerpt:'Em Monaco, €1 milhão compra menos de 20m². O que o mercado global já entendeu sobre valor e densidade urbana.',                                  img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779300854/15__Tuca_Rein%C3%A9s_trvbmq.jpg' },
    { route:'artigo-giverny',          cat:'Jardins e Paisagismo', title:'O Jardim Que Ele Construiu Antes de Pintar.',                                   excerpt:'Monet levou 43 anos construindo Giverny. A obra mais importante que ele criou nunca apareceu em uma moldura.',                                  img:'https://res.cloudinary.com/dovqcebdt/image/upload/c_fill,w_740,h_1110,q_auto:good,f_auto/v1779388716/the_japanese_footbridge_1992.9.1_gaozko.jpg' },
  ];

  const post = HOME_POSTS[Math.floor(Date.now() / 86400000) % HOME_POSTS.length];
  /* home é "/slug/" em produção (pretty URL) ou "slug.html" em preview local/legado */
  const href = /\.html$/.test(location.pathname) ? `${post.route}.html` : `/${post.route}/`;
